<!--
Sync Impact Report
- Version change: 1.0.0 → 1.1.0 (MINOR: explicit relock; idle MUST NOT PIN-lock)
- Modified principles: II Security (add operator-only session drop); III Appliance (idle must not clear cookie)
- Added sections: none
